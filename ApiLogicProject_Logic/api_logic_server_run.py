...
==============================================================================
    ...
    This file starts the API Logic Server (v 07.00.41, January 29, 2023 10:18:16):
...
app_logger.info(f'Created January 29, 2023 10:18:16 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 07.00.41\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 07.00.41\n'
    if is_docker():
