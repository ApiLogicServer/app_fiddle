...
==============================================================================
    ...
    This file starts the API Logic Server (v 07.00.54, February 06, 2023 16:49:02):
...
app_logger.info(f'Created February 06, 2023 16:49:02 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 07.00.54\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 07.00.54\n'
    if is_docker():
