...
==============================================================================
    ...
    This file starts the API Logic Server (v 07.00.44, January 30, 2023 15:36:43):
...
app_logger.info(f'Created January 30, 2023 15:36:43 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 07.00.44\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 07.00.44\n'
    if is_docker():
