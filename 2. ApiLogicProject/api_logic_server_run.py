...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.00.04, February 19, 2023 06:53:05):
...
app_logger.info(f'Created February 19, 2023 06:53:05 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.00.04\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.00.04\n'
    if is_docker():
