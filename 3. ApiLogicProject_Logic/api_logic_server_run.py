...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.01.05, March 05, 2023 08:24:01):
...
app_logger.info(f'Created March 05, 2023 08:24:01 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.01.05\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.01.05\n'
    if is_docker():
