...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.01.00, February 26, 2023 20:23:51):
...
app_logger.info(f'Created February 26, 2023 20:23:51 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.01.00\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.01.00\n'
    if is_docker():
