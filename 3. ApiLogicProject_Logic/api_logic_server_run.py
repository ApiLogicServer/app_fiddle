...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.00.02, February 16, 2023 19:41:44):
...
app_logger.info(f'Created February 16, 2023 19:41:44 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.00.02\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.00.02\n'
    if is_docker():
