...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.00.03, February 17, 2023 20:01:27):
...
app_logger.info(f'Created February 17, 2023 20:01:27 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.00.03\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.00.03\n'
    if is_docker():
